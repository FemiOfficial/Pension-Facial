<div class="col-md-6 home-page">
	...
	<div class="profile-summary">
				...
				<div class="col-md-5 miscellaneous">
					<div class="news-feed">
					<div class="news-feed-header">
						<h4><b style="font-family: 'calibri', sans-serif;"><i class="fa fa-rss-square" style="padding-right: 15px;"></i>BLOG NEWS</b></h4>			
					</div>
					<div class="news-feed-content">
						<h5 style="text-transform: uppercase;color:#eb316e;"><b>Buhari Arrives London</b></h5>
						Lorem ipsumh hdfhfhga hfgsgfgg gsfgfgsfg sdgsgfgsgg gsgfgfg gsgfhfh ggfg
						gsggsfgg hdfhhsfh gfgsgfg shfhshfh hshfgsfg hshfhsfh hsfhshfh<br>
						<a href="">Read More....</a>
						<h5 style="text-transform: uppercase;color:#eb316e;"><b>Pensioners celebrate new biometric technology</b></h5>
						Lorem ipsumh hdfhfhga hfgsgfgg gsfgfgsfg sdgsgfgsgg gsgfgfg gsgfhfh ggfg
						gsggsfgg hdfhhsfh gfgsgfg shfhshfh hshfgsfg hshfhsfh hsfhshfh<br>
						<a href="">Read More....</a>
					</div>
